...
function myzen_preprocess_node(&$variables) {
  $variables['calendar_month'] = format_date($variables['node']->created, 'custom', 'M');
  $variables['calendar_day'] = format_date($variables['node']->created, 'custom', 'j');
  $variables['calendar_year'] = format_date($variables['node']->created, 'custom', 'Y');
}
