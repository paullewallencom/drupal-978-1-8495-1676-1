 ...
 * @ingroup themeable
 */
function myzen_pager($variables) {
  $tags = $variables['tags'];
  ...
  if ($pager_total[$element] > 1) {
    ...
    // When there is more than one page, add a page tracker.
    $items[] = array(
      'class' => array('pager-tracker'),
      'data' => t('[@current/@total]', array('@current' => $pager_current, '@total' => $pager_max)),
    );
/*
